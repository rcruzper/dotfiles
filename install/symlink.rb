...
module Symlink
  ...
  def install
    ...
    Dir['**/*.symlink'].each do |symlink|
      ...
      if File.exists?(target) || File.symlink?(target)
        unless skip_all || overwrite_all || backup_all
          Log.user "File already exists: #{target}, what do you want to do? [s]kip, [S]kip all, [o]verwrite, [O]verwrite all, [b]ackup, [B]ackup all? "
    ...
    Log.success 'Installing symlinks'
  end
